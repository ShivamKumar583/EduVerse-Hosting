...
import { useMeetingAppContext } from "../../MeetingAppProvider";
import useMediaStream from "../../hooks/useMediaStream";
import { FaCheck, FaChevronDown, FaClipboard } from "react-icons/fa";
...
export function BottomBar({
  ...
  return isMobile || isTab ? (
    ...
    >
      ...
      <WebCamBTN />
      <RecordingBTN />
      <OutlinedButton Icon={RxDotsHorizontal} onClick={handleClickFAB} />
