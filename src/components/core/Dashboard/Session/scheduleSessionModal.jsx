    ...
    <div className="fixed inset-0 z-[1000] !mt-0 grid h-screen w-screen place-items-center overflow-auto bg-white bg-opacity-10 backdrop-blur-sm">
      <div className="my-10 w-11/12 max-w-[700px] rounded-lg border border-primaryDark3 bg-primaryDark">
        ...
        <div className="flex items-center justify-between rounded-t-lg bg-primaryDark4 p-5">
          <p className="text-xl font-semibold text-primaryLight">Selec Date and Time</p>
          <button onClick={() => setSessionModal(false)}>
            <RxCross2 className="text-2xl text-richblack-5" />
          </button>
        </div>
        {/* Modal Body */}
        <div className="p-6 text-primaryLight ">
          ...
          >
            ...
            <div className="flex w-11/12 flex-col space-y-2 ml-16 md:-mr-10">
              ...
              <DatePicker
                ...
                showTimeSelect
                dateFormat="Pp" className=' bg-primaryDark4 text-primaryLight rounded-md text-center'
              />
            ...
            <div className="mt-6 flex w-11/12 justify-end gap-x-2 -ml-10">
              <button
                ...
                className={`flex cursor-pointer items-center gap-x-2 rounded-md bg-primaryDark4 py-[8px] px-[20px] font-semibold text-primaryLight3`}
              >
                Cancel
              </button>
