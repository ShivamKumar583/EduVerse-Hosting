...
const About = () => {
  return (
    <div className=' mt-14'>
        ...
        <section className=' bg-richblack-700'>
            <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
                <header className='mx-auto py-20 text-4xl font-semibold lg:w-[70%]'>
                    Driving Innovation in Online Education for accountType
        ...
        <section>
            ...
            {/* fouding box */}
                ...
                {/* left box */}
                    ...
                    {/* box right */}
                    <div>
                        <img src={FoundingImg} className='shadow-[0_0_20px_0] shadow-[#FC6767]'/>
                    </div>
                </div>
            ...
            {/* vision mission box */}
                <div className=' flex flex-col items-center lg:gap-10 lg:flex-row justify-between'>
                    ...
                    <h1 class="bg-gradient-to-b from-[#FF512F] to-[#F09819] bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%] ">Our Vision</h1>
                        <p className='text-base font-medium text-richblack-300 lg:w-[95%]'>
        ...
        {/* section 6 */}
        <section className="relative mx-auto my-20 flex w-11/12 max-w-maxContent flex-col  justify-between gap-8 bg-richblack-900 text-white">
        <h1 class="text-center text-4xl font-semibold mt-8 text-white mb-4">Reviews from other learners</h1>
